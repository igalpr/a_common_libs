...
module Acl::IssueQueryPatch
  def self.included(base)
    ...
    base.class_eval do
      ...
      alias_method :add_available_filter, :acl
      alias_method :type_for, :acl
      alias_method :sql_for_custom_field, :acl
      alias_method :group_by_column, :acl
      alias_method :sort_clause, :acl
    end
  end
